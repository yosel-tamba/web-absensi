...
class Laporan extends CI_Controller
{
    function __construct()
    {
        ...
        if ($this->session->userdata('status') != "telah_login") {
            ...
            redirect(base_url());
        } else if ($this->session->userdata('level') != "Wali Kelas") {
            $this->session->set_flashdata('failed_d', 'Anda Bukan Wali Kelas!');
            redirect(base_url());
        }
    ...
    public function tambah_kehadiran()
    {
        ...
        redirect(base_url() . 'wali_kelas/laporan/detail/' . $id_siswa);
    }
    ...
    public function aksi_filter()
    {
        ...
        if ($this->form_validation->run() != false) {
            ...
            //mengalihkan halaman
            redirect(base_url('wali_kelas/laporan/hasil_filter/'  . $id_jurusan . '/' . $id_kelas . '/' . $dari_tgl . '/' . $sampai_tgl . '/' . $status));
        } else {
            $this->session->set_flashdata('failed', validation_errors());
            redirect(base_url() . 'wali_kelas/laporan');
        }
    }
